...
export default function RegisterView() {
  ...
  const [metroRegion, setMetroRegion] = useState('');
  ...
  return (
    <div className={styles.register}>
      ...
      <form onSubmit={handleSubmit} className={styles.formInfo}>
        ...
        <div className={styles.formControl}>
          <label htmlFor='metroRegion'>Where in Columbus are you ready to play?:</label>
          <select
            id="metroRegion"
            value={metroRegion}
            onChange={(event) => setMetroRegion(event.target.value)}
            className={styles.select}
            required
          >
            <option value="">Select an Option Below</option>
            <option value="downtown">Downtown/Midtown</option>
