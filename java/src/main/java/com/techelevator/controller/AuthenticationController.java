...
import com.techelevator.model.dto.AuthDtos.LoginDto;
import com.techelevator.model.dto.AuthDtos.LoginResponseDto;
...
//        try {
            if (userDao.getUserByUsername(registerUserDto.getUsername()) != null) {
